...
import { submitContactForm } from "../Service/Operations/UserOpern";
...
function ContactPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await submitContactForm("POST", formData, token);
      ...
      <div className="bg-gray-50">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <div className="space-y-6">
                ...
                <button
                  ...
                  className="w-full bg-indigo-600 text-white px-6 py-3 rounded-lg shadow hover:bg-indigo-700 transition focus:outline-none focus:ring-2 focus:ring-indigo-500 cursor-pointer"
                >
                  Send Message
                </button>
              </div>
        ...
        {showModal && (
          <Modal
            ...
            text="To submit the form you need to login first"
